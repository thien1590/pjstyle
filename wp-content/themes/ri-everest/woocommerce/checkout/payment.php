...
<div id="payment" class="woocommerce-checkout-payment">
	<h3 class="title"><?php _e('Payment menthod','ri-everest')?></h3>
	...
	<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="primary-font" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
