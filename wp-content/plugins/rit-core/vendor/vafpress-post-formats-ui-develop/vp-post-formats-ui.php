    ...
    function vp_pfui_add_meta_boxes($post_type)
    {
        if (post_type_supports($post_type, 'post-formats') && current_theme_supports('post-formats')) {
            ...
            wp_localize_script(
                ...
                'vp_pfui_post_format',
                array(
                    'loading' => esc_html__('Loading...', 'vp-post-formats-ui'),
                    'wpspin_light' => admin_url('images/wpspin_light.gif'),
                    'media_title' => esc_html__('Pick Gallery Images', 'vp-post-formats-ui'),
                    'media_button' => esc_html__('Add Image(s)', 'vp-post-formats-ui')
                )
            );
