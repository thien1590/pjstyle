...
if (!function_exists('rit_member_slider_integrate_vc')) {
    function rit_member_slider_integrate_vc()
    {
        vc_map(
            array(
                'name' => esc_html__('RIT Member Slider', RIT_TEXT_DOMAIN),
                'base' => 'rit_member_slider',
                'icon' => 'icon-rit',
                'category' => esc_html__('RIT', RIT_TEXT_DOMAIN),
                'description' => esc_html__('Show member carousel', RIT_TEXT_DOMAIN),
                'params' => array(
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Number of member', RIT_TEXT_DOMAIN),
                        'value' => '',
                        'param_name' => 'posts_per_page',
                        'description' => esc_html__('Number of member in slide', RIT_TEXT_DOMAIN),
                    ),
                    array(
                        'type' => 'textfield',
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Member size', RIT_TEXT_DOMAIN ),
                        'param_name' => 'size',
                        'value' => 'medium',
